...
open class ColorMatchTabsViewController: UITabBarController {
  ...
  open weak var dataSource: ColorMatchTabsViewControllerDataSource? {
    didSet {
      ...
      _view.navigationBar.backgroundColor = dataSource!.navigationBarBackgroundColor()
    }
  }
...
extension ColorMatchTabsViewController: ColorTabsDataSource {
  open func buttonTintColor() -> UIColor {
    return dataSource!.buttonTintColor()
  }
  
  open func titleTextColor() -> UIColor {
    return dataSource!.titleTextColor()
  }
  
  open func titleFont() -> UIFont {
    return dataSource!.titleFont()
  }
  
  open func backgroundColor() -> UIColor {
    return dataSource!.backgroundColor()
  }
  
  open func hightlightIconTintColor(_ index: Int) -> UIColor {
    return dataSource!.hightlightIconTintColor(index)
  }
  
  open func normalIconTintColor() -> UIColor {
    return dataSource!.normalIconTintColor()
  }
